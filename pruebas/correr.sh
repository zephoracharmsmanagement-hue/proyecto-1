...
ROJAS=""
for BATERIA in regresion stock dudas precios inventario disponibilidad pedidos rescate correo-tienda hoja reponer meta enlace reanudar armar-carrito checkout envio-estado pixel paginas; do
  echo "──────── $BATERIA ────────"
