...
ROJAS=""
for BATERIA in regresion stock dudas precios inventario disponibilidad prompt-bot pedidos rescate correo-tienda hoja reponer meta enlace reanudar armar-carrito checkout envio-estado; do
  echo "──────── $BATERIA ────────"
