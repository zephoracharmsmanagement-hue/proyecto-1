...
function abrirFicha(id){
  ...
  if(esB){
    fila('Material','Plata Esterlina 925 legítima, con el sello S925 grabado');
...
function render(){
  ...
  if(!base&&!sel.length){
    ...
    if(base) body.appendChild(fila(base.id,PU[base.id].n.replace(/^Pulsera /,''),
      'Brazalete · Plata 925'+(base.talla?' · Talla '+base.talla+' cm':''),
